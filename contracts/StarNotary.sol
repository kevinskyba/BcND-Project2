...
contract StarNotary is ERC721 {
    ...
    string public name = "UdacyStars";

    string public symbol = "UDS";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender,
            "Either tokenId1 or tokenId2 must be owned for transfer");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "Sender must be owner of tokenId");
